...
2. [Stable Diffusion 3.5 Medium](https://huggingface.co/stabilityai/stable-diffusion-3.5-medium)（社群 demo: 含 SuperPrompt）
...
3. 回到「**把一句話描述得清晰可見**」這件事：如果要跟人述說你想拍什麼，描述就顯得相當重要，除非你想要自己走出去隨手就拍，但是隨手拍攝、一個人作業時常會變得勞累，或是變得不那麼有趣、不容易吸睛，所以學會**述說故事**是相當重要的一件事。
